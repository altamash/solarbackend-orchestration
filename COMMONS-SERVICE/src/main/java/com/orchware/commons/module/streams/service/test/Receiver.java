...
public class Receiver {
    ...
    private static final String storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=devstoragesi;AccountKey=xJ4RKi/X5aOvNLdK+ObgNI2zpiXrD5vvyFVMDk61KP8lkK6FW+SHXkdT6dS3JmS+5v3Qs975PvR2Wo8scBUDFg==;EndpointSuffix=core.windows.net";
    private static final String storageContainerName = "streams";
